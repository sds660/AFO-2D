/*
 * JQ uery plugin brought in for the purpose of a loading screen
 * 
...
(function ($) {
      $.loader_ext = {
            ...
            defaults: {
                  ...
                  title: '', //文字
                  isOnly: true,
                  imgUrl: '../client/assets/loading/loading[size].gif',
                  fullScreen: false,
                  onShow: function () {
                  },  //打开回调
                  onClose: function () {
            ...
            set_define: function () {
                  ...
                  if (ops.fullScreen) {
                        loading.css({
                              "background-image": "url('../client/assets/loading/menuBackgroundLoading.png')",
                              "opacity": 1,
                              "z-index":500,
                        });
                  } 
